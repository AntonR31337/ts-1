...
// export const showData = (entity: Book | Notepad): any => {
//   entity.showData(entity);
// };
...
const main = () => {
  ...
  // console.log(getFrom<Notepad>(notepads, "title 2"));
  
  books["title 1"].showData();
  // console.log(showData(notepads["title 2"]));
